...
describe('UpdateChaptersManga (US 8)', () => {
  ...
  describe('US 11 — Descendre sous 0 interdit', () => {
    it('devrait retourner une erreur si lus passe sous 0', async () => {
      const manga = { id: 1, titre: 'One Piece', nombreDeChapitres: 100, nombreDeChapitresLus: 5, activé: true };
  ...
  describe('US 11 — Passage à 0 exact', () => {
    it('devrait accepter si lus arrive à 0', async () => {
      const manga = { id: 1, titre: 'One Piece', nombreDeChapitres: 100, nombreDeChapitresLus: 10, activé: true };
