...
describe('UpdateChaptersManhwa (US 8)', () => {
  ...
  describe('US 9 — chapitres_lus > total interdit', () => {
    it('devrait retourner une erreur si chapitres_lus dépasse le total', async () => {
      const manhwa = { id: 1, titre: 'Solo Leveling', nombreDeChapitres: 100, nombreDeChapitresLus: 99, activé: true };
  ...
  describe('US 10 — Suppression dépassant 0', () => {
    it('devrait retourner une erreur si le total passe sous 0', async () => {
      const manhwa = { id: 1, titre: 'Solo Leveling', nombreDeChapitres: 5, nombreDeChapitresLus: 3, activé: true };
  ...
  describe('US 10 — lus > nouveau total interdit', () => {
    it('devrait retourner une erreur si lus dépasse le nouveau total', async () => {
      const manhwa = { id: 1, titre: 'Solo Leveling', nombreDeChapitres: 100, nombreDeChapitresLus: 95, activé: true };
  ...
  describe('US 10 — Cas limite exact', () => {
    it('devrait accepter si lus == nouveau total', async () => {
      const manhwa = { id: 1, titre: 'Solo Leveling', nombreDeChapitres: 100, nombreDeChapitresLus: 90, activé: true };
  ...
  describe('US 11 — Descendre sous 0 interdit', () => {
    it('devrait retourner une erreur si lus passe sous 0', async () => {
      const manhwa = { id: 1, titre: 'Solo Leveling', nombreDeChapitres: 100, nombreDeChapitresLus: 5, activé: true };
  ...
  describe('US 11 — Passage à 0 exact', () => {
    it('devrait accepter si lus arrive à 0', async () => {
      const manhwa = { id: 1, titre: 'Solo Leveling', nombreDeChapitres: 100, nombreDeChapitresLus: 10, activé: true };
